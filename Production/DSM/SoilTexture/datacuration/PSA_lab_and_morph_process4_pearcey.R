...
# morph data
morph.data<- readRDS(file = "Z:/projects/ternlandscapes_2019/soiltexture/data/process3/combined_morph_PSA_data_labPSA_checks_removed.rds")
...
# save object
saveRDS(object = dat.fin, file = paste0("Z:/projects/ternlandscapes_2019/soiltexture/data/process4/morph_sims/combined_morph_data_2020-01_sim_",ii,".rds"))
}
