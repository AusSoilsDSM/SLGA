...
#G1<- c("P10_PB_C","P10_PB_CS","P10_PB_FS","P10_PB_S","P10_PB_Z")
...
# save output
saveRDS(nproc_z, file = "Z:/projects/ternlandscapes_2019/soiltexture/data/process1/waGov_lab_PSA_data.rds")
