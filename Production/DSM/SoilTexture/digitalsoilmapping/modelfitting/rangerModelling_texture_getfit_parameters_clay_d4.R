...
hist(test3$`clay_30-60 cm`)

# clay model 
test4<- test3[-which(test3$`clay_30-60 cm`<= -15),] # something strange with the data and had to change the logical
hist(test4$`clay_30-60 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`clay_30-60 cm`
...
## capture output
var_nm1<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/parameterOptimisation/rangerModel_params_clay_d4.txt"
...
saveRDS(ranger.model, "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/parameterOptimisation/rangerModel_params_clay_d4.rds")
