...
## capture output
var_nm1<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/parameterOptimisation/rangerModel_params_clay_d1.txt"
...
saveRDS(ranger.model, "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/parameterOptimisation/rangerModel_params_clay_d1.rds")
