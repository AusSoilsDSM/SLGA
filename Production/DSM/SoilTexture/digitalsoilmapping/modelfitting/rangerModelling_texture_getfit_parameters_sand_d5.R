...
hist(test3$`sand_60-100 cm`)

# clay model 
test4<- test3[-which(test3$`sand_60-100 cm`<= -50),] # something strange with the data and had to change the logical
...
## capture output
var_nm1<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/parameterOptimisation/rangerModel_params_sand_d5.txt"
...
saveRDS(ranger.model, "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/parameterOptimisation/rangerModel_params_sand_d5.rds")
