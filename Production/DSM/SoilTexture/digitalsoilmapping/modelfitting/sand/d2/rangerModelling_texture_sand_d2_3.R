...
# root
vart<- "sand"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/sand/d2/"
depth<- "d2"
...
optimparams<- optimparams[8,] # need to change for variable and depth
