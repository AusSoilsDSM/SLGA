...
## Ranger models
# rscript:  source("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/rcode/digitalsoilmapping/modelfitting/clay/d1/rangerModelling_texture_clay_d1_1.R")
# slurm:    source("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/clay/d1/slurm")

# root
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/sand/d1/"
cnt=1 ## BATCH NUMBER
vart<- "sand"
depth<- "d1"
...
optimparams<- optimparams[7,]
optimparams

## External validation
ex.samps<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d1.clay.10per.sampled1.clay.10per.sample.rds")
ex.samps.dat<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d1_clay_external_val.rds")
names(ex.samps.dat)
...
#hist(test3$`sand_0-5 cm`)

# sand model 
test4<- test3[-which(test3$`sand_0-5 cm`== -9999),]
#hist(test4$`sand_0-5 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`sand_0-5 cm`
