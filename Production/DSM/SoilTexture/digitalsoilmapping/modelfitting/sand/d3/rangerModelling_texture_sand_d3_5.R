...
# root
vart<- "sand"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/sand/d3/"
depth<- "d3"
...
optimparams<- optimparams[9,] # need to change for variable and depth

## External validation
ex.samps<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d3.clay.10per.sampled1.clay.10per.sample.rds")
ex.samps.dat<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d3_clay_external_val.rds")
names(ex.samps.dat)
...
# sand model 
test4<- test3[-which(test3$`sand_15-30 cm`== -9999),]
hist(test4$`sand_15-30 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`sand_15-30 cm`
