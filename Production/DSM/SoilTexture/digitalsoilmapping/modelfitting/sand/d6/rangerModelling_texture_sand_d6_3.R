...
# root
vart<- "sand"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/sand/d6/"
depth<- "d6"
...
optimparams<- optimparams[12,] # need to change for variable and depth
optimparams

## External validation
ex.samps<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d6.clay.10per.sampled1.clay.10per.sample.rds")
ex.samps.dat<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d6_clay_external_val.rds")
names(ex.samps.dat)
...
# clay model 
test4<- test3[-which(test3$`sand_100-200 cm` < -50),]
hist(test4$`sand_100-200 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`sand_100-200 cm`
