...
# root
vart<- "clay"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/clay/d3/"
depth<- "d3"
...
optimparams<- optimparams[3,] # need to change for variable and depth
...
# clay model 
test4<- test3[-which(test3$`clay_15-30 cm`== -9999),]
#hist(test4$`clay_15-30 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`clay_15-30 cm`
