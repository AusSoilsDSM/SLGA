...
# root
vart<- "clay"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/clay/d5/"
depth<- "d5"
...
optimparams<- optimparams[5,] # need to change for variable and depth
optimparams
...
# clay model 
test4<- test3[-which(test3$`clay_60-100 cm`< -50),]
#hist(test4$`clay_60-100 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`clay_60-100 cm`
