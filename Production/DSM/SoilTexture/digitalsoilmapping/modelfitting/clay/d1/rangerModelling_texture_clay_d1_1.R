...
# root
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/clay/d1/"
cnt=1 ## BATCH NUMBER
vart<- "clay"
depth<- "d1"
...
#hist(test3$`clay_0-5 cm`)

# clay model 
test4<- test3[-which(test3$`clay_0-5 cm`== -9999),]
#hist(test4$`clay_0-5 cm`)
test4$relief_geomorphons<- as.factor(test4$relief_geomorphons)
test4$target<- test4$`clay_0-5 cm`
