...
# root
vart<- "clay"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/clay/d4/"
depth<- "d4"
...
optimparams<- optimparams[4,] # need to change for variable and depth
...
# clay model 
test4<- test3[-which(test3$`clay_30-60 cm`< -50),]
