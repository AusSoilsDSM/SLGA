...
# root
vart<- "clay"
root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/clay/d2/"
depth<- "d2"
...
optimparams<- optimparams[2,] # need to change for variable and depth

## External validation
ex.samps<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d2.clay.10per.sampled1.clay.10per.sample.rds")
ex.samps.dat<- readRDS("/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soiltexture/models/d2_clay_external_val.rds")
names(ex.samps.dat)
