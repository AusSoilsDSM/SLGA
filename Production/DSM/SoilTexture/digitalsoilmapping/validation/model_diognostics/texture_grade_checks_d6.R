...
## DEPTH 6
### clay external observations and predictions: depth 6
vart<- "clay"
depth<- "d6"
...
### sand external observations and predictions: depth 6
vart<- "sand"
depth<- "d6"
...
saveRDS(d1.summary, file = paste0(root, "diognostics/d6_texture_class_check.rds"))
