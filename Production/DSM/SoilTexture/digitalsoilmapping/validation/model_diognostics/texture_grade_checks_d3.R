...
## DEPTH 3
### clay external observations and predictions: depth 3
vart<- "clay"
depth<- "d3"
...
### sand external observations and predictions: depth 3
vart<- "sand"
depth<- "d3"
...
saveRDS(d1.summary, file = paste0(root, "diognostics/d3_texture_class_check.rds"))
