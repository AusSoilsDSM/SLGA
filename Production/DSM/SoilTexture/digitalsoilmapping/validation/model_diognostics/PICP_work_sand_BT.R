...
# diognostics
diog.data<- readRDS(file = paste0(root,"sand_d1_diogs_BT.rds"))
# average mse 
...
for (i in 1:ncol(bMat)){
  bMat[,i] <- as.numeric(observation.data[,2] <= uMat[,i] & observation.data[,2] >= lMat[,i])} 
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_sand_d1_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"sand_d2_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_sand_d2_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"sand_d3_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_sand_d3_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"sand_d4_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_sand_d4_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"sand_d5_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_sand_d5_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"sand_d6_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_sand_d6_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
