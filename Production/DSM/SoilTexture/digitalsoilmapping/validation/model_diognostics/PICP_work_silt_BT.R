...
## D1
# prediction data
pred.data<- readRDS(file = paste0(root,"silt_d1_pred_data_BT.rds"))
dim(pred.data)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"silt_d1_diogs_BT.rds"))
# average mse 
...
for (i in 1:ncol(bMat)){
  bMat[,i] <- as.numeric(observation.data[,3] <= uMat[,i] & observation.data[,3] >= lMat[,i])} 
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_silt_d1_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
...
## D2
# prediction data
pred.data<- readRDS(file = paste0(root,"silt_d2_pred_data_BT.rds"))
dim(pred.data)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"silt_d2_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_silt_d2_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
## D3
# prediction data
pred.data<- readRDS(file = paste0(root,"silt_d3_pred_data_BT.rds"))
dim(pred.data)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"silt_d3_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_silt_d3_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
## D4
# prediction data
pred.data<- readRDS(file = paste0(root,"silt_d4_pred_data_BT.rds"))
dim(pred.data)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"silt_d4_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_silt_d4_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
## D5
# prediction data
pred.data<- readRDS(file = paste0(root,"silt_d5_pred_data_BT.rds"))
dim(pred.data)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"silt_d5_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_silt_d5_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
...
## D6
# prediction data
pred.data<- readRDS(file = paste0(root,"silt_d6_pred_data_BT.rds"))
dim(pred.data)
...
# diognostics
diog.data<- readRDS(file = paste0(root,"silt_d6_diogs_BT.rds"))
# average mse 
avgMSE<- mean(diog.data$MSE)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"picp_silt_d6_BT.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(cs,((colSums(bMat)/ nrow(bMat))*100),xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="PICP (%)", xlab= "Confidence level (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from =0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (cs,((colSums(bMat)/ nrow(bMat))*100),,pch=1, col="black", cex=1)
