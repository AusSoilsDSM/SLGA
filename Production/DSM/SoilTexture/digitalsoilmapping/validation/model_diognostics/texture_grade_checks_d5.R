...
## DEPTH 5
### clay external observations and predictions: depth 5
vart<- "clay"
depth<- "d5"
...
### sand external observations and predictions: depth 5
vart<- "sand"
depth<- "d5"
...
saveRDS(d1.summary, file = paste0(root, "diognostics/d5_texture_class_check.rds"))
