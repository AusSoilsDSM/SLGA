...
my_breaks <- c(5000, 10000, 20000, 50000,100000, 150000)
...
ggplot(hexdf, aes(x=x, y=y)) +
  ...
  labs(x = "observed ilr comp sand", y = "predicted ilr comp sand") +
  coord_fixed(xlim = c(-5, 2),
              ylim = c(-5, 2)) +
...
my_breaks <- c(10000, 20000, 50000,100000, 150000,300000)
clrs <- rev(brewer.pal(length(my_breaks) + 3, "Blues"))
clrs <- clrs[3:length(clrs)]
hexdf$countColor <- cut(hexdf$counts,
                        breaks = c(0, my_breaks, Inf),
...
ggplot(hexdf, aes(x=x, y=y)) +
  ...
  scale_fill_gradientn(colors=rev(clrs[-1]),
                       ...
                       name="Count") +
  geom_abline(intercept = 0, color = "black", size = 1) +
  labs(x = "observed irl comp sand", y = "predicted irl comp sand") +
  coord_fixed(xlim = c(-5, 2),
              ylim = c(-5, 2)) +
  theme(aspect.ratio=1,text = element_text(size=20)) 
...
my_breaks <- c(1000, 5000, 10000, 20000, 50000,150000)
clrs <- rev(brewer.pal(length(my_breaks) + 3, "Blues"))
clrs <- clrs[3:length(clrs)]
hexdf$countColor <- cut(hexdf$counts,
                        breaks = c(0, my_breaks, Inf),
...
my_breaks <- c(1000, 5000, 10000, 20000, 50000, 120000)
clrs <- rev(brewer.pal(length(my_breaks) + 3, "Blues"))
clrs <- clrs[3:length(clrs)]
hexdf$countColor <- cut(hexdf$counts,
                        breaks = c(0, my_breaks, Inf),
...
my_breaks <- c(1000, 5000, 10000, 20000, 50000,100000)
clrs <- rev(brewer.pal(length(my_breaks) + 3, "Blues"))
clrs <- clrs[3:length(clrs)]
hexdf$countColor <- cut(hexdf$counts,
                        breaks = c(0, my_breaks, Inf),
