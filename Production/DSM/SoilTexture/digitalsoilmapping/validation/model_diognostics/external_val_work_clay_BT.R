...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"BT/tern_v2_val_clay_d1.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(observation.data[,1], val.mean,xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="predicted clay (%)", xlab= "observed clay (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
...
points (observation.data[,1], val.mean,pch=1, col="black", cex=0.1)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"BT/tern_v2_val_clay_d2.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(observation.data[,1], val.mean,xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="predicted clay (%)", xlab= "observed clay (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (observation.data[,1], val.mean,pch=1, col="black", cex=0.1)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"BT/tern_v2_val_clay_d3.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(observation.data[,1], val.mean,xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="predicted clay (%)", xlab= "observed clay (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (observation.data[,1], val.mean,pch=1, col="black", cex=0.1)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"BT/tern_v2_val_clay_d4.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(observation.data[,1], val.mean,xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="predicted clay (%)", xlab= "observed clay (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (observation.data[,1], val.mean,pch=1, col="black", cex=0.1)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"BT/tern_v2_val_clay_d5.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(observation.data[,1], val.mean,xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="predicted clay (%)", xlab= "observed clay (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (observation.data[,1], val.mean,pch=1, col="black", cex=0.1)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(fig.root,"BT/tern_v2_val_clay_d6.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
plot(observation.data[,1], val.mean,xlim= xlimits, ylim= ylimits, type= "n",axes=F,ylab="predicted clay (%)", xlab= "observed clay (%)",col="black", font.lab=2,cex.lab=1.5,font=2, font.axis=2, family="sans")
axis(side=2,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
axis(side=1,at=seq(from = 0,to = 100,by = 10),font=2, font.axis=2, family="sans",lty=1, lwd=1,cex.axis=1.2, col="black")
points (observation.data[,1], val.mean,pch=1, col="black", cex=0.1)
