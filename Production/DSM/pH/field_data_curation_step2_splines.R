...
# root directory
root<- "Z:/projects/ternlandscapes_2019/soil_pH/data/fieldObs/curated_field/"


# files
lab.dat<- readRDS(paste0(root, "curated_step1_fieldpH.rds"))
...
write.csv(yave, paste0(root,"splined_field_ph.csv"),row.names = F)
saveRDS(yave,paste0(root,"splined_field_ph.rds"))

# Error checking between obs and spline predictions
write.csv(dave, paste0(root,"splined_field_ph_errors.csv"), row.names = F)
saveRDS(dave,paste0(root,"splined_field_ph_errors.rds"))

# Original dataset but flagged for data to remove
write.csv(d.dat, paste0(root,"splined_field_ph_origdat.csv"),row.names = F)
saveRDS(d.dat,paste0(root,"splined_field_ph_origdat.rds"))
...
# Original dataset but flagged for data to remove
write.csv(yave, paste0(root, "field_ph_data_splined_dsm_ARD.csv"),row.names = F)
saveRDS(yave,paste0(root, "field_ph_data_splined_dsm_ARD.rds"))
