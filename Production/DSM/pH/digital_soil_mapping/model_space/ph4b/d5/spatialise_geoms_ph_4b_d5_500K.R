...
# libraries
library(sp);library(rgdal);library(raster);library(sf)
...
root.models<- paste0(g.root,"models/",vart,"/d",depth,"/geoms/")
root.slurm<- paste0(g.root,"rcode/slurm/",vart,"/temp_outs/digital_soil_mapping/model_space/500K/d",depth,"/")
