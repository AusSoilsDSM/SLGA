...
ranger.model<-train(x= sub.site.dat[,2:40], y= sub.site.dat$alldat_geom_bin,method = "ranger",trControl = trainControl(method = "oob"), num.trees =  500)  
summary(ranger.model)
ranger.model

## capture output
var_nm1<- paste0(params.out,"rangerModel_alldat_geom_params_",vart, "_",depth,".txt")
