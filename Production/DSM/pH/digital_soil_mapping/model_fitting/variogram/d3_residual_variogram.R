...
#data
# site data
site.dat<- readRDS(paste0(data.root,"tern_soilpH4a1_siteDat_covariates_CALVALDAT_SimulationAverages_d3.rds"))
...
saveRDS(object = site.dat, file = paste0(data.root,"tern_soilpH4a1_siteDat_covariates_CALVALDAT_SimulationResiduals_d3.rds"))
...
saveRDS(site.dat, paste0(data.root,"variogram_dat/4a1/tern_soilpH4a1_siteDat_covariates_CALVALDAT_SimulationResiduals_d3_ARD.rds"))
saveRDS(afit, paste0(model.out,"variogram_models/4a1/residuals_variogram_4a1_d3.rds"))
