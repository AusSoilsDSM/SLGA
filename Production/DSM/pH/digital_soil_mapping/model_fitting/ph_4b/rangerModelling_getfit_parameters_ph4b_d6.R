...
names(site.dat)
sel.col<- 14
sub.site.dat<- site.dat[,c(1:8,sel.col,16,17:55)] # change column selection for target variable
...
## capture output
var_nm1<- paste0(params.out,"rangerModel_params_ph4b_d6.txt")
