...
# lab dat
names(site.dat)
sub.site.dat<- site.dat[,c(1:8,13,16,17:55)] # change column selection for target variable
...
## capture output
var_nm1<- paste0(params.out,"rangerModel_params_ph4a1_d5.txt")
...
saveRDS(ranger.model, paste0(model.out,"rangerModel_params_ph4a1_d5.rds"))
