...
slurm.root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soil_pH/rcode/digital_soil_mapping/spatialprediction/slurm/pH_4a1_residuals/d5/"
r.code<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soil_pH/rcode/digital_soil_mapping/spatialprediction/d5/residuals/residual_modelling_rangermodels_pearcey_spatialise_d5_1.R"
...
# variogram
afit<- readRDS(paste0(model.out,"residuals_variogram_4a1_d5.rds"))
plot(afit)
