...
slurm.root<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soil_pH/rcode/digital_soil_mapping/spatialprediction/slurm/pH_4a1_residuals/d1/"
r.code<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soil_pH/rcode/digital_soil_mapping/spatialprediction/d1/residuals/residual_modelling_rangermodels_pearcey_spatialise_d1_1.R"
...
# variogram
afit<- readRDS(paste0(model.out,"residuals_variogram_4a1_d1.rds"))
plot(afit)
