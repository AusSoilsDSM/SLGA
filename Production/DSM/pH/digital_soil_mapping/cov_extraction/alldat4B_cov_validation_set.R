...
# site data
site.dat<- readRDS(paste0(data.root,"tern_soilpH4B_siteDat_covariates_20220822.rds"))
names(site.dat)
...
#save object
saveRDS(ext.data, file = paste0(data.root,"tern_soilpH4B_siteDat_covariates_20223008_EXTERNAL_ARD.rds"))
saveRDS(therest.dat, file = paste0(data.root,"tern_soilpH4B_siteDat_covariates_20223008_CALVALDAT_ARD.rds"))
