...
# depth 1
# variogram
afit<- readRDS(paste0(model.out,"variogram_models/4a1/residuals_variogram_4a1_d3.rds"))
plot(afit)
...
## capture output
var_nm1<- paste0(fig.root, "external_val_diogs_4a1_d3.txt")
...
xlimits= c(3,12)
ylimits= c(3,12) 
tiff(file=paste0(fig.root,"external_val_pred_d3.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
...
xlimits= c(3,12)
ylimits= c(3,12) 
tiff(file=paste0(fig.root,"external_val_predRK_d3.tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
...
# write data to file
saveRDS(object = kdat, file = paste0(fig.root,"external_val_outs_d3_4a1.rds"))


#######################################
kdat<- readRDS(file = paste0(fig.root,"external_val_outs_d3_4a1.rds"))
