...
# CODE PURPOSE
# Evaluate model prediction uncertainites
...
# load data
ext.dat<- read.csv(file = paste0(data.root,"ranger_EXT_preds_pH4b_depth_",depth,"_summary.csv"))
...
cluster.files<- cluster.files[66]
error.files<- error.files[66]
