...
r.code<- "/datasets/work/af-tern-mal-deb/work/projects/ternlandscapes_2019/soil_pH/rcode/digital_soil_mapping/mosaic/tile_mosaic_4a1_median_d2.R"
...
#file name output
f.name<- paste0(root, depth, "/", vart, "/", vart, "_", vart3, "_", depth, ".tif")
f.name
#file name input
f.name.in<- paste0("pred_", vart, "_", vart2, "_", depth)
f.name.in
