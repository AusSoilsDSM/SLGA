...
# root directory
root<- "Z:/projects/ternlandscapes_2019/soil_pH/data/curated_lab/4A1/"


# files
lab.dat<- readRDS(paste0(root, "curated_step1_labpH_4A1.rds"))
...
write.csv(yave, paste0(root,"splined_lab_4A1.csv"),row.names = F)
saveRDS(yave,paste0(root,"splined_lab_4A1.rds"))

# Error checking between obs and spline predictions
write.csv(dave, paste0(root,"splined_lab_4A1_errors.csv"), row.names = F)
saveRDS(dave,paste0(root,"splined_lab_4A1_errors.rds"))

# Original dataset but flagged for data to remove
write.csv(d.dat, paste0(root,"splined_lab_4A1_origdat.csv"),row.names = F)
saveRDS(d.dat,paste0(root,"splined_lab_4A1_origdat.rds"))
...
# Original dataset but flagged for data to remove
write.csv(yave, paste0(root, "lab_ph_4A1_data_splined_dsm_ARD.csv"),row.names = F)
saveRDS(yave,paste0(root, "lab_ph_4A1_data_splined_dsm_ARD.rds"))
