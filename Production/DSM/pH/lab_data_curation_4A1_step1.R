...
# libraries
root<- "Z:/projects/ternlandscapes_2019/soil_pH/data/labObs/4A1/"
root.out<- "Z:/projects/ternlandscapes_2019/soil_pH/data/curated_lab/4A1/"
...
for (i in 1:length(files)){
  ...
  print(nrow(imp.dat))
  sel.dat<- rbind(sel.dat,imp.dat[,c("DataStore", "Dataset", "Provider", "Location_ID",
                                     "Layer_ID", "SampleID","SampleDate","Longitude",
                                     "Latitude", "UpperDepth", "LowerDepth","PropertyType",
...
saveRDS(object = new.data.sub, file = paste0(root.out, "curated_step1_labpH_4A1.rds"))
