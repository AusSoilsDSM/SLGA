...
# libraries
root<- "Z:/projects/ternlandscapes_2019/soil_pH/data/labObs/4B2/"
root.out<- "Z:/projects/ternlandscapes_2019/soil_pH/data/curated_lab/4B2/"
...
saveRDS(object = new.data.sub, file = paste0(root.out, "curated_step1_labpH_4B2.rds"))
