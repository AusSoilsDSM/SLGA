...
input.data<- readRDS(file = paste0(cluster.out, "cluster_centers_totalP_all.rds"))
site.data<- read.table(file = paste0(site.root, "ranger_VAL_preds_average_summaries_totalP_depth_alldepth.txt"),header = T, sep = ",")
