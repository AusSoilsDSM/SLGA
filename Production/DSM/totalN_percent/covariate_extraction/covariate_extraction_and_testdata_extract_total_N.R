...
# soil texture and soc data
all.data <- read.csv(paste0(g.root,"data/ross/TotalN-Splines.csv"))
names(all.data)
...
st_write(all.data.sf, paste0(g.root,"data/ross/tern_total_N_sites.shp"))
...
#save object
saveRDS(DSM_data6, file = paste0(g.root,"data/ross/model_ready/tern_totalN_labelled_covariates_ALL.rds"))
DSM_data6<- readRDS(file = paste0(g.root,"data/ross/model_ready/tern_totalN_labelled_covariates_ALL.rds"))
...
#save object
saveRDS(cal.dat, file = paste0(g.root,"data/ross/model_ready/tern_totalN_labelled_covariates_CAL.rds"))
saveRDS(test.dat, file = paste0(g.root,"data/ross/model_ready/tern_totalN_labelled_covariates_TEST.rds"))
