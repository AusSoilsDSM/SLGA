...
# load data
input.data<- read.csv(file = paste0(input.root,"ranger_EXT_preds_",vart,"_depth_",1,"_summary.csv"))
names(input.data)
...
xlimits= c(0,100)
ylimits= c(0,100) 
tiff(file=paste0(data.outs,"external_val_", vart, "_PICP_clustering_",depth,".tiff"),width=12,height=12,units="cm",res=300,pointsize=8)
