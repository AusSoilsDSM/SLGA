...
possible.combis <- list(c("HOC.5.15","POC.5.15","ROC.5.15"),
                        c("HOC.5.15","ROC.5.15","POC.5.15"),
                        c("ROC.5.15","POC.5.15","HOC.5.15"),
                        c("ROC.5.15","HOC.5.15","POC.5.15"),
                        c("POC.5.15","ROC.5.15","HOC.5.15"),
                        c("POC.5.15","HOC.5.15","ROC.5.15"))
...
save.image("C:/Users/mrom8073/OneDrive - The University of Sydney (Staff)/SOC_saturation/Output_Comparison/5_15/comparison.RData")
load("C:/Users/mrom8073/OneDrive - The University of Sydney (Staff)/SOC_saturation/Output_Comparison/5_15/comparison.RData")
...
obser = SolarDiagram.list2$HOC.5.15
obser = SolarDiagram.list2$POC.5.15
obser = SolarDiagram.list2$ROC.5.15
