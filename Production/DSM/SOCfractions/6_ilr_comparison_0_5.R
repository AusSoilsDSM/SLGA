...
mydata <- data.frame(HOC=SOCFr$HOC.0.5, POC=SOCFr$POC.0.5, ROC=SOCFr$ROC.0.5)
...
possible.combis <- list(c("HOC.0.5","POC.0.5","ROC.0.5"),
                        c("HOC.0.5","ROC.0.5","POC.0.5"),
                        c("ROC.0.5","POC.0.5","HOC.0.5"),
                        c("ROC.0.5","HOC.0.5","POC.0.5"),
                        c("POC.0.5","ROC.0.5","HOC.0.5"),
                        c("POC.0.5","HOC.0.5","ROC.0.5"))
...
save.image("C:/Users/mrom8073/OneDrive - The University of Sydney (Staff)/SOC_saturation/Output_Comparison/0_5/comparison.RData")
load("C:/Users/mrom8073/OneDrive - The University of Sydney (Staff)/SOC_saturation/Output_Comparison/0_5/comparison.RData")
...
rm("aes.list", "Backt", "backtf","column.names","dat.train" ,"data","data.depth",
   ...
   ROC.var, some.seeds, some.seeds2,HOC.var, POC.var, form.HOC, form.POC, form.ROC)
...
obser = SolarDiagram.list2$HOC.0.5
obser = SolarDiagram.list2$POC.0.5
obser = SolarDiagram.list2$ROC.0.5
