...
probe.locs<- read.csv("/datasets/work/af-tern-mal-deb/work/projects/GRDC_soilwaternow/model_averaging/data/soil_probe_data/EP/EP_probesToUse.csv")
names(probe.locs)
...
write.csv(x = DSM_data,file = "/datasets/work/af-tern-mal-deb/work/projects/GRDC_soilwaternow/model_averaging/data/soil_probe_data/EP/EP_probesToUse_SLGA_DUL_LL.csv",row.names = F)
