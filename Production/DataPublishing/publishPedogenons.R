...
att <- "Pedogenons"
inRasterPath <- '/datasets/work/lw-soildatarepo/work/http/Products/TERN/Other/PdgnAus_k1370_COG.tif'

infoDir <- '/datasets/work/af-digiscapesm/work/Ross/SLGA/SLGA/Production/NationalMaps/DataPublishing'

outDir <- paste0('/datasets/work/lw-soildatarepo/work/http/Products/TERN/Other/Pedogeneons')

if(!dir.exists(outDir)){dir.create(outDir)}
templateRp <- '/datasets/work/af-tern-mal-deb/work/datasets/national/covariates/mosaics/90m/Relief_dems_3s_mosaic1.tif'
outPath <- paste0(outDir, '/Pedogeneons.tif')
...
writeRaster(rr, tmpPath, overwrite = T, datatype='INT2U')
rc <- rast(paste0('/scratch1/', ident, '/tmp.tif'))
rc
